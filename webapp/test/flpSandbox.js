		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comincturevanithamamapplications-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comincturevanithamamapplications-display": {
								"semanticObject": "comincturevanithamamapplications",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.incture.vanithamamapplications",
									"url": sap.ui.require.toUrl("com/incture/vanithamamapplications")
								}
							}
						}
					}
